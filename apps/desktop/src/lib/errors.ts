...
/**
 * Map backend / runtime errors to user-facing Chinese text. Tries, in order:
 * 1. RemoteApiError.code — mapped to a known message
 * 2. Network-ish error signatures (TypeError: fetch failed / Load failed)
 * 3. Fallback to the raw message
 */
