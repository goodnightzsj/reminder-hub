              ...
              {rows.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Status Badges - Subtle soft style */}
                    <div className="mb-4 flex flex-wrap gap-2">
                      {item.autoRenew ? (
                        <span className="inline-flex items-center rounded-md bg-success/10 px-2 py-1 text-[11px] font-medium text-success">
                          自动续费
                        </span>
                      ) : (
                        <span className="inline-flex items-center rounded-md bg-surface px-2 py-1 text-[11px] font-medium text-secondary">
                          手动续期
                        </span>
                      )}
                      {item.isArchived && (
                        <span className="inline-flex items-center rounded-md bg-surface px-2 py-1 text-[11px] font-medium text-muted">
                          已归档
                        </span>
                      )}
                    </div>

                    {/* Payment Info Box - Modern Clean */}
                    <div className="flex flex-col gap-3 rounded-xl bg-surface/60 p-4 transition-colors hover:bg-surface">
