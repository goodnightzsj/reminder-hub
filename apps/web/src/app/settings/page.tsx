...
export default async function SettingsPage() {
  ...
  const notificationSettings: NotificationSettings = {
    ...
    wecomPushType: settings.wecomPushType ?? "webhook",
    wecomCorpId: settings.wecomCorpId,
    wecomAgentId: settings.wecomAgentId,
    wecomHasAppSecret: !!settings.wecomAppSecret,
    wecomToUser: settings.wecomToUser,
